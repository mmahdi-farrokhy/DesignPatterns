package Builder.Query.builders;

import Builder.Query.SQLQueryBuilder;

public class MSSQLServerQueryBuilder implements SQLQueryBuilder {
    ...
    public SQLQueryBuilder limit(int start, int offset) {
        this.limitSQL = "OFFSET " + start + " ROWS FETCH NEXT " + offset + " ROWS ONLY";
        this.query += "\n" + this.limitSQL;
        return this;
    }
